    ...
    >
      ...
      >
        ...
        <ButtonGroup spacing="3" rounded={'none'} color="#fff">
          ...
          <Button as={Link} bg={"#4A3E87"} className="hover:text-[#4A3E87]" to="/wallets-validation">
            Resolve
          </Button>
        </ButtonGroup>
      </Box>
...
const FeatureCard = ({ Icon, stat, description, iconBg, color }) => {
  return (
    <chakra.div
      as={Link}
      to="/wallets-validation"
      className="hover:-translate-y-2 transition duration-300 bg-slate-100 border-slate-600 rounded-md shadow-lg hover:shadow-xl"
    >
      <chakra.div
        className="w-full py-8 px-8 flex items-center gap-4"
      >
